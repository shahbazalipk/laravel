...
class ExhibitorController extends Controller
{
    ...
    public function create()
    {
        ...
        $customForms = $this->audienceForms->activeForms(FormAudience::Exhibitor);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $exhibitor = DB::transaction(function () use ($request, $validated) {
                $this->audienceForms->validate(FormAudience::Exhibitor, $request);
                $exhibitor = $this->service->createExhibitor($validated);
    ...
    public function edit(Exhibitor $exhibitor)
    {
        ...
        $tags = ExhibitorTag::active()->ordered()->get();
        $customForms = $this->audienceForms->activeForms(FormAudience::Exhibitor);
        $customFormResponses = $this->audienceForms->existingResponses($exhibitor, $customForms);
    ...
    public function update(Request $request, Exhibitor $exhibitor)
    {
        ...
        try {
            DB::transaction(function () use ($request, $exhibitor, $validated) {
                $this->audienceForms->validate(FormAudience::Exhibitor, $request, $exhibitor);
