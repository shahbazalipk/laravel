...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add Booth Type</h1>
            <p class="text-gray-600 mt-1">Create a new booth type category</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <form action="{{ route('admin.booth-types.store') }}" method="POST">
        @csrf
