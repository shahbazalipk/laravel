...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add Email Provider</h1>
            <p class="text-gray-600 mt-1">Configure a new email service provider for campaigns</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.email-campaigns.provider-configs.store') }}" method="POST" id="provider-form">
        @csrf
        ...
        <div class="mb-6">
            ...
            <select name="provider_name" 
                ...
                @foreach($availableProviders as $key => $name)
                    <option value="{{ $key }}" {{ old('provider_name') == $key ? 'selected' : '' }}>
                        {{ $name }}
                    </option>
                @endforeach
            </select>
        ...
        <!-- Infobip Credentials -->
        <div id="infobip-fields" class="provider-fields hidden">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="url" 
                           name="base_url" 
                           id="infobip_base_url" 
                           value="{{ old('base_url', 'https://api.infobip.com') }}"
        ...
        <div id="mailchimp-fields" class="provider-fields hidden">
        ...
        <!-- SMTP Credentials -->
        <div id="smtp-fields" class="provider-fields hidden">
