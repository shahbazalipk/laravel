...
@section('title', 'Edit Registration Category')
...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Registration Category</h1>
            <p class="text-gray-600 mt-1">Update registration category details</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.registration-categories.update', $registrationCategory) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="{{ old('name', $registrationCategory->name) }}"
                ...
                <div>
                    ...
                    <select name="mobile_persona_id" 
                        ...
                        @foreach($personas as $persona)
                            <option value="{{ $persona->id }}" {{ old('mobile_persona_id', $registrationCategory->mobile_persona_id) == $persona->id ? 'selected' : '' }}>
                                {{ $persona->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" 
                               ...
                               value="{{ old('mobile_persona_color', $registrationCategory->mobile_persona_color ?? '#6366f1') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           name="badge_name" 
                           id="badge_name" 
                           value="{{ old('badge_name', $registrationCategory->badge_name) }}"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="instructions_text" 
                              ...
                              placeholder="Brief instructions for registrants">{{ old('instructions_text', $registrationCategory->instructions_text) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="instruction_description" 
                              ...
                              placeholder="Detailed description or additional instructions">{{ old('instruction_description', $registrationCategory->instruction_description) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" 
                           name="valid_from" 
                           id="valid_from" 
                           value="{{ old('valid_from', $registrationCategory->valid_from?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="date" 
                           name="valid_to" 
                           id="valid_to" 
                           value="{{ old('valid_to', $registrationCategory->valid_to?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="price" 
                           id="price" 
                           value="{{ old('price', $registrationCategory->price) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="currency" 
                           id="currency" 
                           value="{{ old('currency', $registrationCategory->currency) }}"
                           maxlength="3"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="vat_percentage" 
                           id="vat_percentage" 
                           value="{{ old('vat_percentage', $registrationCategory->vat_percentage) }}"
                           step="0.01"
                           min="0"
                           max="100"
                ...
                <div class="flex items-center">
                    <label class="flex items-center">
                        <input type="checkbox" 
                               name="show_trn" 
                               value="1"
                               {{ old('show_trn', $registrationCategory->show_trn) ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    <label class="flex items-center">
                        <input type="checkbox" 
                               name="visible" 
                               value="1"
                               {{ old('visible', $registrationCategory->visible) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input type="number" 
                           name="capacity" 
                           id="capacity" 
                           value="{{ old('capacity', $registrationCategory->capacity) }}"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="minimum_items" 
                           id="minimum_items" 
                           value="{{ old('minimum_items', $registrationCategory->minimum_items) }}"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="maximum_items" 
                           id="maximum_items" 
                           value="{{ old('maximum_items', $registrationCategory->maximum_items) }}"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           id="minimum_options" 
                           value="{{ old('minimum_options', $registrationCategory->minimum_options) }}"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           id="maximum_options" 
                           value="{{ old('maximum_options', $registrationCategory->maximum_options) }}"
                           min="0"
        ...
        <div class="mb-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('need_professional_student_id', $registrationCategory->need_professional_student_id) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <div id="professional-id-message-section" class="{{ old('need_professional_student_id', $registrationCategory->need_professional_student_id) ? '' : 'hidden' }}">
                    ...
                    <textarea name="professional_student_id_message" 
                              ...
                              placeholder="Message to display when requesting ID">{{ old('professional_student_id_message', $registrationCategory->professional_student_id_message) }}</textarea>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('need_membership_id', $registrationCategory->need_membership_id) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                        <span class="ml-2 text-sm text-gray-700">Require Membership ID</span>
                    </label>
                </div>

                <div id="membership-section" class="{{ old('need_membership_id', $registrationCategory->need_membership_id) ? '' : 'hidden' }} space-y-6">
                    <!-- Membership -->
                    <div>
                        ...
                        <select name="membership_id" 
                            ...
                            @foreach($memberships as $membership)
                                <option value="{{ $membership->id }}" {{ old('membership_id', $registrationCategory->membership_id) == $membership->id ? 'selected' : '' }}>
                                    {{ $membership->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <textarea name="membership_not_found_message" 
                                  ...
                                  placeholder="Message when membership ID is not found">{{ old('membership_not_found_message', $registrationCategory->membership_not_found_message) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="membership_invalid_message" 
                                  ...
                                  placeholder="Message when membership ID is invalid">{{ old('membership_invalid_message', $registrationCategory->membership_invalid_message) }}</textarea>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="needs_password"
                               value="1"
                               {{ old('needs_password', $registrationCategory->needs_password) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <!-- Password -->
                <div id="password-section" class="{{ old('needs_password', $registrationCategory->needs_password) ? '' : 'hidden' }}">
                    ...
                    <input type="text" 
                           name="password" 
                           id="password" 
                           value="{{ old('password', $registrationCategory->password) }}"
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               name="sponsored" 
                               value="1"
                               {{ old('sponsored', $registrationCategory->sponsored) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               name="send_to_dtcm" 
                               value="1"
                               {{ old('send_to_dtcm', $registrationCategory->send_to_dtcm) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           name="pipelines" 
                           id="pipelines" 
                           value="{{ old('pipelines', $registrationCategory->pipelines) }}"
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" 
                               name="color" 
                               id="color" 
                               value="{{ old('color', $registrationCategory->color ?? '#6366f1') }}"
                               class="h-10 w-20 border border-gray-300 rounded cursor-pointer">
                        <input type="text" 
                               id="color-text"
                               value="{{ old('color', $registrationCategory->color ?? '#6366f1') }}"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="sort_order" 
                           id="sort_order" 
                           value="{{ old('sort_order', $registrationCategory->sort_order) }}"
            ...
            <div class="mt-6">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Optional description for this category">{{ old('description', $registrationCategory->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="mb-8">
            <label class="flex items-center">
                <input type="checkbox" 
                       name="is_active" 
                       value="1"
                       {{ old('is_active', $registrationCategory->is_active) ? 'checked' : '' }}
                       class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
