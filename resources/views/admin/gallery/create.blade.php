...
<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data" id="upload-form">
        ...
        <div class="mb-6">
            <label for="gallery_album_id" class="block text-sm font-medium text-gray-700 mb-2">
                Select Album <span class="text-red-500">*</span>
            </label>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Don't see your album? <a href="{{ route('admin.gallery-albums.create') }}" class="text-indigo-600 hover:text-indigo-800">Create a new album</a>
            </p>
        </div>
