...
@section('title', 'Create Badge Design')
...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Badge Design</h1>
            <p class="text-gray-600 mt-1">Customize how badges look for your event</p>
        </div>
    </div>
</div>

<form action="{{ route('admin.badge-designs.store') }}" method="POST">
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="size" id="size" class="w-full rounded-lg border-gray-300">
                            <option value="4x6" {{ old('size', '4x6') == '4x6' ? 'selected' : '' }}>4" x 6"</option>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="color" name="header_bg_color" value="{{ old('header_bg_color', '#4F46E5') }}"
                                   class="w-full h-10 rounded border-gray-300">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Text Color</label>
                            <input type="color" name="header_text_color" value="{{ old('header_text_color', '#FFFFFF') }}"
                                   class="w-full h-10 rounded border-gray-300">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_event_logo" value="1" {{ old('show_event_logo', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                            <span class="ml-2 text-sm text-gray-700">Show Event Logo</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="show_event_name" value="1" {{ old('show_event_name', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                            <span class="ml-2 text-sm text-gray-700">Show Event Name</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="show_event_dates" value="1" {{ old('show_event_dates', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_profile_picture" value="1" {{ old('show_profile_picture', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                        ...
                        <select name="profile_picture_shape" class="rounded-lg border-gray-300 text-sm">
                            <option value="circle" {{ old('profile_picture_shape', 'circle') == 'circle' ? 'selected' : '' }}>Circle</option>
                    ...
                    <div class="flex items-center gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_name" value="1" {{ old('show_name', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                        ...
                        <select name="name_font_size" class="rounded-lg border-gray-300 text-sm">
                            ...
                            <option value="3xl" {{ old('name_font_size', '3xl') == '3xl' ? 'selected' : '' }}>Medium</option>
                            <option value="4xl" {{ old('name_font_size') == '4xl' ? 'selected' : '' }}>Large</option>
                        </select>
                    </div>

                    <label class="flex items-center">
                        <input type="checkbox" name="show_job_title" value="1" {{ old('show_job_title', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600">
                        <span class="ml-2 text-sm text-gray-700">Show Job Title</span>
                    </label>

                    <label class="flex items-center">
                        <input type="checkbox" name="show_company" value="1" {{ old('show_company', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600">
                    ...
                    <div class="flex items-center gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_category" value="1" {{ old('show_category', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                        ...
                        <select name="category_style" class="rounded-lg border-gray-300 text-sm">
                            <option value="badge" {{ old('category_style', 'badge') == 'badge' ? 'selected' : '' }}>Badge Style</option>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="show_qr_code" value="1" {{ old('show_qr_code', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="qr_code_size" class="w-full rounded-lg border-gray-300">
                                ...
                                <option value="32" {{ old('qr_code_size', '32') == '32' ? 'selected' : '' }}>Medium (128px)</option>
                        ...
                        <div>
                            ...
                            <select name="qr_code_position" class="w-full rounded-lg border-gray-300">
                                ...
                                <option value="center" {{ old('qr_code_position', 'center') == 'center' ? 'selected' : '' }}>Center</option>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Background Color</label>
                        <input type="color" name="footer_bg_color" value="{{ old('footer_bg_color', '#F3F4F6') }}"
                               class="w-full h-10 rounded border-gray-300">
                    </div>

                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_registration_number" value="1" {{ old('show_registration_number', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                            <span class="ml-2 text-sm text-gray-700">Show Registration Number</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="show_location" value="1" {{ old('show_location', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
                            <span class="ml-2 text-sm text-gray-700">Show Location</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="show_website" value="1" {{ old('show_website', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="show_border" value="1" {{ old('show_border', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="color" name="border_color" value="{{ old('border_color', '#4F46E5') }}"
                                   class="w-full h-10 rounded border-gray-300">
                        </div>
                        <div>
                            ...
                            <select name="border_width" class="w-full rounded-lg border-gray-300">
                                ...
                                <option value="4" {{ old('border_width', '4') == '4' ? 'selected' : '' }}>Medium (4px)</option>
