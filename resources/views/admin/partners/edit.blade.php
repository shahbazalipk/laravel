...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <form action="{{ route('admin.partners.update', $partner->hash) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <label class="flex items-center">
                    <input type="checkbox" name="visible_on_ebadge" value="1" {{ old('visible_on_ebadge', $partner->visible_on_ebadge) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    <span class="ml-2 text-sm text-gray-700">Visible on e-badge</span>
                </label>
                <label class="flex items-center">
                    <input type="checkbox" name="visible_on_exhibitor_portal" value="1" {{ old('visible_on_exhibitor_portal', $partner->visible_on_exhibitor_portal) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    <span class="ml-2 text-sm text-gray-700">Visible on Exhibitor Portal</span>
                </label>
                <label class="flex items-center">
                    <input type="checkbox" name="visible_on_group_portal" value="1" {{ old('visible_on_group_portal', $partner->visible_on_group_portal) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    <span class="ml-2 text-sm text-gray-700">Visible on Group Portal</span>
                </label>
                <label class="flex items-center">
                    <input type="checkbox" name="visible_online" value="1" {{ old('visible_online', $partner->visible_online) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    <span class="ml-2 text-sm text-gray-700">Visible Online</span>
                </label>
                <label class="flex items-center">
                    <input type="checkbox" name="visible_onsite" value="1" {{ old('visible_onsite', $partner->visible_onsite) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                <label for="sponsorship_label" class="block text-sm font-medium text-gray-700 mb-2">
                    Partnership Label <span class="text-red-500">*</span>
                </label>
                <input type="text" name="sponsorship_label" id="sponsorship_label" value="{{ old('sponsorship_label', $partner->sponsorship_label) }}"
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="4"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $partner->description) }}</textarea>
            @error('description')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                @if($partner->logo_thumbnail_url)
                    <div class="mb-2">
                        <img src="{{ $partner->logo_thumbnail_url }}" alt="Current thumbnail" class="w-32 h-32 object-contain border rounded">
            ...
            <div>
                ...
                @if($partner->logo_defined_size_url)
                    <div class="mb-2">
                        <img src="{{ $partner->logo_defined_size_url }}" alt="Current defined size" class="w-32 h-32 object-contain border rounded">
                        <p class="text-xs text-gray-500 mt-1">Current logo</p>
                    </div>
                @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="email" name="contact_email" id="contact_email" value="{{ old('contact_email', $partner->contact_email) }}"
            ...
            <div>
                ...
                <input type="tel" name="contact_phone" id="contact_phone" value="{{ old('contact_phone', $partner->contact_phone) }}"
