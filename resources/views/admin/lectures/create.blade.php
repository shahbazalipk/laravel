...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Lecture</h1>
            <p class="text-gray-600 mt-1">Add a new lecture to a session</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.lectures.store') }}" method="POST">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="topic" id="topic" value="{{ old('topic') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('topic') border-red-500 @enderror"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          placeholder="Lecture description">{{ old('description') }}</textarea>
        ...
        <div class="mt-8 flex justify-end space-x-3">
            ...
            <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">Create Lecture</button>
        </div>
    </form>
</div>
@endsection
