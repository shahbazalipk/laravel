...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Persona</h1>
            <p class="text-gray-600 mt-1">Update persona information</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.personas.update', $persona) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" 
                       name="sort_order" 
                       id="sort_order" 
                       value="{{ old('sort_order', $persona->sort_order) }}"
        ...
        <div class="mt-6">
            ...
            <textarea name="description" 
                      ...
                      placeholder="Optional description for this persona type">{{ old('description', $persona->description) }}</textarea>
            @error('description')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
