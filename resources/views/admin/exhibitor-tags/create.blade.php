...
@section('title', 'Add Exhibitor Tag')
...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add Exhibitor Tag</h1>
            <p class="text-gray-600 mt-1">Create a new exhibitor tag</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <form action="{{ route('admin.exhibitor-tags.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}"
                       ...
                       placeholder="e.g., Featured Exhibitor"
                       required>
                @error('name')
