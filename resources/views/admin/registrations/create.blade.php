...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Registration</h1>
            <p class="text-gray-600 mt-1">Add a new event registration</p>
        </div>
    </div>
</div>
                ...
                <select name="registration_category_id" 
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" 
                                ...
                                {{ old('registration_category_id') == $category->id ? 'selected' : '' }}>
