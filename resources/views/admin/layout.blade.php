    ...
    <nav class="bg-indigo-900 text-white shadow-lg">
                    ...
                    <div class="hidden lg:flex items-center space-x-1 desktop-menu">
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class="dropdown-menu absolute right-0 z-50 mt-2 hidden max-h-[calc(100vh-6rem)] w-72 overflow-y-auto rounded-xl bg-white py-2 shadow-xl ring-1 ring-black/5">
                                ...
                                <a href="{{ route('admin.promo-codes.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50">Promo Codes</a>
                                ...
                                <a href="{{ route('admin.memberships.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50">Membership Lists</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="mobile-menu lg:hidden bg-indigo-800 border-t border-indigo-700">
            <div class="px-4 py-3 space-y-2 max-h-96 overflow-y-auto">
                ...
                <a href="{{ route('admin.memberships.index') }}" class="block px-3 py-2 rounded text-sm hover:bg-indigo-700">Membership Lists</a>
                <a href="{{ route('admin.promo-codes.index') }}" class="block px-3 py-2 rounded text-sm hover:bg-indigo-700">Promo Codes</a>
