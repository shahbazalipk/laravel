...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Location</h1>
            <p class="text-gray-600 mt-1">Add a new venue or room</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.locations.store') }}" method="POST">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}"
                       ...
                       placeholder="e.g., Main Conference Hall" required>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3"
                          ...
                          placeholder="Full address of the venue">{{ old('address') }}</textarea>
        ...
        <div class="mt-8 flex justify-end space-x-3">
            ...
            <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">Create Location</button>
        </div>
    </form>
</div>
@endsection
