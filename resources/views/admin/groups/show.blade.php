...
<div class="mb-6 flex flex-wrap gap-3">
    ...
    @endif
    @if($group->is_vip)
        <span class="px-3 py-1 inline-flex text-sm font-semibold rounded-full bg-yellow-100 text-yellow-800">VIP</span>
    @endif
    @php
        $headerPaymentStatus = $paymentSummary['summary_status'];
    @endphp
    <span class="px-3 py-1 inline-flex text-sm font-semibold rounded-full {{ $headerPaymentStatus->badgeClasses() }}">
    ...
    <span class="px-3 py-1 inline-flex text-sm font-semibold rounded-full bg-indigo-100 text-indigo-800">
        Members: {{ $group->registrations->count() }} / {{ $group->allowed_attendees }}
    </span>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        @include('admin.groups.partials.members')

        @include('admin.groups.partials.payment-history')
    ...
    <div class="space-y-6">
        ...
        @include('admin.groups.partials.payment-summary')
...
@include('admin.groups.partials.payment-modals')
@endsection
