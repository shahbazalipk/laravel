...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Update group information</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.groups.update', $group) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="border-b border-gray-200 mb-6">
            <nav class="-mb-px flex space-x-8">
                <button type="button" onclick="switchTab('basic')" id="tab-basic" class="tab-button border-b-2 border-indigo-500 py-4 px-1 text-sm font-medium text-indigo-600">
                    Basic Information
                </button>
                <button type="button" onclick="switchTab('contact')" id="tab-contact" class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                    Contact Details
                </button>
                <button type="button" onclick="switchTab('address')" id="tab-address" class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
        ...
        <div id="content-basic" class="tab-content">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="group_type_id" 
                        ...
                        @foreach($groupTypes as $type)
                            <option value="{{ $type->id }}" {{ old('group_type_id', $group->group_type_id) == $type->id ? 'selected' : '' }}>
                                {{ $type->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('organization_name', $group->organization_name) }}"
                ...
                <div>
                    ...
                    <select name="industry_id" 
                        ...
                        @foreach($industries as $industry)
                            <option value="{{ $industry->id }}" {{ old('industry_id', $group->industry_id) == $industry->id ? 'selected' : '' }}>
                                {{ $industry->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('allowed_attendees', $group->allowed_attendees) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="invoice_number" 
                           id="invoice_number" 
                           value="{{ old('invoice_number', $group->invoice_number) }}"
                ...
                <div>
                    ...
                    <input type="url" 
                           name="website_url" 
                           id="website_url" 
                           value="{{ old('website_url', $group->website_url) }}"
            ...
            <div class="mt-6">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Brief description about the group">{{ old('description', $group->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div id="content-contact" class="tab-content hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('primary_contact_name', $group->primary_contact_name) }}"
                ...
                <div>
                    ...
                    <input type="email" 
                           ...
                           value="{{ old('primary_contact_email', $group->primary_contact_email) }}"
                ...
                <div>
                    ...
                    <input type="tel" 
                           ...
                           value="{{ old('primary_contact_phone', $group->primary_contact_phone) }}"
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Secondary Contact (Optional)</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('secondary_contact_name', $group->secondary_contact_name) }}"
                ...
                <div>
                    ...
                    <input type="email" 
                           ...
                           value="{{ old('secondary_contact_email', $group->secondary_contact_email) }}"
                ...
                <div>
                    ...
                    <input type="tel" 
                           ...
                           value="{{ old('secondary_contact_phone', $group->secondary_contact_phone) }}"
        ...
        <div id="content-address" class="tab-content hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="postal_code" 
                           id="postal_code" 
                           value="{{ old('postal_code', $group->postal_code) }}"
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Special Requirements</h3>
            <div>
                ...
                <textarea name="special_requirements" 
                          ...
                          placeholder="Dietary restrictions, accessibility needs, etc.">{{ old('special_requirements', $group->special_requirements) }}</textarea>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               name="is_vip" 
                               value="1"
                               {{ old('is_vip', $group->is_vip) ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
