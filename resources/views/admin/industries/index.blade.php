...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Industrys</h1>
...
@if($industries->isEmpty())
    ...
    <div class="bg-white rounded-lg shadow-sm p-12 text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-800 mb-2">No Industrys Found</h3>
        <p class="text-gray-600 mb-4">Get started by creating your first industry.</p>
        <a href="{{ route('admin.industries.create') }}" 
