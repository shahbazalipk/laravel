...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Create Gallery Album</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.gallery-albums.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div class="mb-4">
                        <label for="cover_photo" class="block text-sm font-medium text-gray-700 mb-2">Upload Cover Photo</label>
                        <input type="file" 
                               name="cover_photo" 
                               id="cover_photo" 
                               accept="image/*"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p class="mt-1 text-xs text-gray-500">This will be displayed at the top of the gallery</p>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('show_cover_at_top', true) ? 'checked' : '' }}
                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="default_photo_status" 
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="published" {{ old('default_photo_status', 'published') == 'published' ? 'selected' : '' }}>Published</option>
                            <option value="unpublished" {{ old('default_photo_status') == 'unpublished' ? 'selected' : '' }}>Unpublished</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <select name="upload_size" 
                                    id="upload_size"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="high_resolution" {{ old('upload_size', 'high_resolution') == 'high_resolution' ? 'selected' : '' }}>High Resolution</option>
                                <option value="web_size" {{ old('upload_size') == 'web_size' ? 'selected' : '' }}>Web Size</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="download_size" 
                                    id="download_size"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="high_resolution" {{ old('download_size', 'high_resolution') == 'high_resolution' ? 'selected' : '' }}>High Resolution</option>
                                <option value="web_size" {{ old('download_size') == 'web_size' ? 'selected' : '' }}>Web Size</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div class="mb-4">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('enable_download', true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div id="form-settings" class="ml-6 space-y-4 {{ old('enable_form') ? '' : 'hidden' }}">
                        <div>
                            ...
                            <select name="gallery_form_id" 
                                ...
                                @foreach($forms as $form)
                                    <option value="{{ $form->id }}" {{ old('gallery_form_id') == $form->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="form_trigger" 
                                ...
                                <option value="on_open" {{ old('form_trigger', 'on_open') == 'on_open' ? 'selected' : '' }}>When user opens the online gallery</option>
                                <option value="delayed" {{ old('form_trigger') == 'delayed' ? 'selected' : '' }}>Seconds after user opens the gallery</option>
                                <option value="on_download" {{ old('form_trigger') == 'on_download' ? 'selected' : '' }}>When user selects download button</option>
                            </select>
                        </div>

                        <div id="delay-field" class="{{ old('form_trigger') == 'delayed' ? '' : 'hidden' }}">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('form_delay_seconds', 0) }}"
                                   min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="form_requirement" 
                                    id="form_requirement"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="optional" {{ old('form_requirement', 'optional') == 'optional' ? 'selected' : '' }}>Optional - User can dismiss form</option>
                                <option value="mandatory" {{ old('form_requirement') == 'mandatory' ? 'selected' : '' }}>Mandatory - User must submit to proceed</option>
                            </select>
                        </div>
                    </div>
                </div>
