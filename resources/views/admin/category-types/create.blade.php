...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Category Type</h1>
            <p class="text-gray-600 mt-1">Add a new category type</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.category-types.store') }}" method="POST">
        ...
        <div class="mt-6">
            ...
            <textarea name="description" 
                      ...
                      placeholder="Optional description for this category type">{{ old('description') }}</textarea>
            @error('description')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
