...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Create Email Template</h1>
            <p class="text-gray-600 mt-1">Create a new reusable email template</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.email-campaigns.email-templates.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="category" 
                    ...
                    <option value="confirmation" {{ old('category') === 'confirmation' ? 'selected' : '' }}>Confirmation</option>
        ...
        <div class="mt-6">
            ...
            <textarea name="text_content" 
                      ...
                      placeholder="Optional plain text version for email clients that don't support HTML">{{ old('text_content') }}</textarea>
            @error('text_content')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    emailTemplateEditor = new EmailTemplateEditor({
        ...
        autoSaveKey: 'email_template_draft_new',
...
slugField.name = 'slug';
nameInput.parentElement.parentElement.appendChild(slugField);
